...
(defmacro pretty-speedbar-chevron-down ()
  ...
  `(defezimage pretty-chevron-down ((:type svg :file ,(expand-file-name "chevron-down.svg" pretty-speedbar-icons-dir) :ascent center)) "Chevron-down image from FontAwesome."))
